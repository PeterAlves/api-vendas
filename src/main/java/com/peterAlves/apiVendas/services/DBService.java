...
import com.peterAlves.apiVendas.domain.Categoria;
...
import com.peterAlves.apiVendas.domain.Pagamento;
import com.peterAlves.apiVendas.domain.PagamentoComBoleto;
import com.peterAlves.apiVendas.domain.PagamentoComCartao;
import com.peterAlves.apiVendas.domain.Pedido;
import com.peterAlves.apiVendas.domain.Produto;
import com.peterAlves.apiVendas.domain.enums.EstadoPagamento;
import com.peterAlves.apiVendas.domain.enums.Perfil;
import com.peterAlves.apiVendas.domain.enums.TipoCliente;
import com.peterAlves.apiVendas.repositories.CategoriaRepository;
...
import com.peterAlves.apiVendas.repositories.ItemPedidoRepository;
import com.peterAlves.apiVendas.repositories.PagamentoRepository;
import com.peterAlves.apiVendas.repositories.PedidoRepository;
import com.peterAlves.apiVendas.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Peter Alves","peterhospdis@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Amanda Silva", "peter.alves@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
